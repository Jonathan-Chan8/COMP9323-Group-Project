...
Revision ID: faa5946dc484
Revises: 
Create Date: 2021-08-05 19:01:13.286391
...
def upgrade():
    ...
    sa.Column('clientStatus', sa.Enum('sent', 'accepted', name='clientStatus'), nullable=True),
